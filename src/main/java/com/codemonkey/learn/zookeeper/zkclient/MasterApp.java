package com.codemonkey.learn.zookeeper.zkclient;
...
public class MasterApp {
	...
	public void initialize() {
		zkClient = new ZkClient("127.0.0.1:2181", 50000);
		if (!zkClient.exists("/root1")) {
			zkClient.create("/root1", new Long(System.currentTimeMillis()),
	...
	private class RootNodeChangeThread implements Runnable {
		public void run() {
			while (true) {
				...
				System.out.println(">>>>>>>>>> 产生随机的 uuid string,'uuidStr'===>"
						+ uuidStr);
